...
function DashboardScreenComponent({
  ...
  const notSynced = telemetry.lastSyncLabel === 'Not synced yet'

  return (
    <section className="screen-shell screen-shell--paged">
      <div className="top-chrome">
        <p className="title-font text-[1.4rem] font-semibold text-[var(--text-primary)]">Today</p>
      </div>

      <ScreenPager ariaLabel="Dashboard">
        {/* Page 1 — Daily wisdom + Begin Session */}
        <ScreenPage
          cta={
            <button
              type="button"
        ...
        {/* Page 2 — Connected core readiness */}
        <ScreenPage>
          <section className="hero-surface hero-surface-dashboard dashboard-hero-shell animate-hero-pulse cinema-surface cinema-surface--hero">
            <div className="hero-dashboard-head">
              ...
              <div className="dashboard-status-chip">{telemetry.healthSourceLabel}</div>
            </div>
          ...
          cta={
            notSynced ? (
              <button
                ...
                onClick={() => { tapFeedback(); onEnableHealthWeather() }}
              >
        ...
        {/* Page 4 — Next session preset */}
        <ScreenPage
          cta={
            <button type="button" className="primary-btn primary-btn-strong w-full justify-center" onClick={onOpenStopwatch}>
